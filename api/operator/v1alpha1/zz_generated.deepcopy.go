// FILE: api/operator/v1alpha1/zz_generated.deepcopy.go
//
// WHAT IT DOES (max 5 lines):
// AUTO-GENERATED FILE containing DeepCopy methods for all API types (HTTP01Proxy,
// CertManager, IstioCSR, etc.). DeepCopy creates independent copies of objects,
// which is required when controllers modify objects (can't mutate cached copies
// from informers). Kubernetes runtime requires all API objects implement
// runtime.Object interface, which includes DeepCopyObject() method.
//
// HOW IT DOES IT (max 5 lines):
// controller-gen tool scans http01proxy_types.go and generates these methods
// by analyzing struct fields. For simple fields (strings, ints), does shallow copy.
// For pointers/slices/maps, allocates new memory and recursively copies. Run
// `make update` to regenerate after changing API types. DO NOT EDIT MANUALLY -
// changes will be overwritten on next generation.

//go:build !ignore_autogenerated
// ↑ Build tag: this file is skipped when ignore_autogenerated build tag is set
...
// ↑ WARNING: Manual edits will be lost when `make update` is run
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
// Used when caller already allocated destination object and wants to copy fields into it
func (in *HTTP01Proxy) DeepCopyInto(out *HTTP01Proxy) {
	*out = *in                                      // Shallow copy all simple fields (strings, ints)
	out.TypeMeta = in.TypeMeta                      // Copy Kind, APIVersion (simple struct, no pointers)
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)     // Deep copy metadata (contains maps/slices like labels, annotations)
	in.Spec.DeepCopyInto(&out.Spec)                 // Deep copy Spec (may contain pointer to CustomDeployment)
	in.Status.DeepCopyInto(&out.Status)             // Deep copy Status (contains Conditions slice)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01Proxy.
// Most commonly used - allocates new object and returns independent copy
func (in *HTTP01Proxy) DeepCopy() *HTTP01Proxy {
	if in == nil {                                   // Nil-safe: copying nil returns nil
		return nil
	}
	out := new(HTTP01Proxy)                          // Allocate new HTTP01Proxy on heap
	in.DeepCopyInto(out)                             // Delegate to DeepCopyInto to copy all fields
	return out                                       // Return pointer to new independent copy
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
// Required by runtime.Object interface - allows Kubernetes to copy objects without knowing concrete type
func (in *HTTP01Proxy) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {                // Call type-specific DeepCopy
		return c                                     // Return as runtime.Object interface
	}
	return nil                                       // Nil if input was nil
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTP01ProxyCustomDeploymentSpec) DeepCopyInto(out *HTTP01ProxyCustomDeploymentSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01ProxyCustomDeploymentSpec.
func (in *HTTP01ProxyCustomDeploymentSpec) DeepCopy() *HTTP01ProxyCustomDeploymentSpec {
	if in == nil {
		return nil
	}
	out := new(HTTP01ProxyCustomDeploymentSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01ProxyList.
...
func (in *HTTP01ProxySpec) DeepCopyInto(out *HTTP01ProxySpec) {
	*out = *in                                       // Copy Mode (string, no deep copy needed)
	if in.CustomDeployment != nil {                  // CustomDeployment is *pointer*, only copy if non-nil
		in, out := &in.CustomDeployment, &out.CustomDeployment  // Shadow variables for clarity
		*out = new(HTTP01ProxyCustomDeploymentSpec)  // Allocate new CustomDeploymentSpec struct
		**out = **in                                 // Copy fields (InternalPort is int32, simple copy)
		// ↑ Double-dereference: dereference pointer to get struct, copy struct value
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01ProxySpec.
func (in *HTTP01ProxySpec) DeepCopy() *HTTP01ProxySpec {
	if in == nil {
		return nil
	}
	out := new(HTTP01ProxySpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTP01ProxyStatus.
func (in *HTTP01ProxyStatus) DeepCopy() *HTTP01ProxyStatus {
	if in == nil {
		return nil
	}
	out := new(HTTP01ProxyStatus)
	in.DeepCopyInto(out)
	return out
}
